...
function processDisks(text) {
    var text1 = [[{'system_id': '47N007A', 'block_size': '299 GB', 'disk_type': 'SAS', 'id': '9480A012F92A', 'name': 'Disk 0 TOSHIBA AL13SXB300N     '}, {'system_id': '47N007A', 'block_size': '299 GB', 'disk_type': 'SAS', 'id': '94E0A069F92A', 'name': 'Disk 1 TOSHIBA AL13SXB300N     '}, {'system_id': '47N007A', 'disk_type': 'SAS', 'block_size': '299 GB', 'id': '94E0A05LF92A', 'name': 'Disk 2 TOSHIBA AL13SXB300N     '}, {'system_id': '47N007A', 'block_size': '299 GB', 'disk_type': 'SAS', 'id': '9430A0BAF92A', 'name': 'Disk 3 TOSHIBA AL13SXB300N     '}], {'47N007A:DG0': {'pool_member': '9480A012F92A 94E0A069F92A 94E0A05LF92A\r\n 9430A0BAF92A', 'total_space': '897 GB', 'free_space': 0, 'id': '47N007A:DG0', 'name': 'RAID5 Disk Group 0'}}];
...
export function disk_info(address) {
    ...
    if (!pr) {
        ...
        cockpit.spawn(["python", "/tmp/disks.py"], { environ: ["LC_ALL=C"], err: "message", superuser: "try" })
